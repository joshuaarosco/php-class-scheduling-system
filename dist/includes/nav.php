...
<div class="navi p-10">
	...
	<a class="btn btn-flat mr-10 <?php echo in_array($curPageName, $display)? 'btn-primary':'btn-link'; ?>" href="sched_display.php">Display Schedule</a>
</div>