      ...
      <div class="container">
        <section class="content">
          <div class="row">
            ...
            <div class="col-md-6">
              <span class="section-title">Salutation List</span>
            </div>
          </div>
          <div class="row mt-13">
           <div class="col-md-2">
                  ...
                  <table class="table table-bordered table-striped" style="margin-right:-10px">
                    ...
                    while($row=mysqli_fetch_array($query)){
                      ...
                      <tr>
                        ...
                        <td>
                          <a id="click" class="mr-5" href="salut.php?id=<?php echo $id;?>&salut=<?php echo $salut;?>">
                            <i class="glyphicon glyphicon-edit text-black"></i>
                            <span class="text-black">Edit</span>
                          </a>
                          <a id="removeme" href="../logic/salut_del.php?id=<?php echo $id;?>">
          ...
          <div class="box border-1">
            <div class="box-body">
              ...
              <div id="form">
                <div class="row">
                  <div class="col-md-12">
                    <form method="post" action="../logic/salut_save.php">
                      <div class="form-group">
                       <span>Add Salutation</span><br>
                       <input type="text" class="form-control border-1" name="salut" placeholder="Salutation" required>
                     </div><!-- /.form group -->
                   </div>
                 </div>	
                 <div class="form-group">
           ...
           <div id="form">
            <form method="post" action="../logic/salut_update.php">
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                   <span>Update Class</span><br>
                   <input type="hidden" class="form-control border-1" id="id" name="id" value="<?php echo $_REQUEST['id'];?>" readonly>
                   <input type="text" class="form-control border-1" id="class" name="salut" value="<?php echo $_REQUEST['salut'];?>" placeholder="Salutation" required>
                 </div><!-- /.form group -->
               </div>
             </div>	
