      ...
      <div class="container">
        ...
        <section class="content">
                  ...
                  <table id="example1" class="table table-bordered table-striped border-1" style="margin-right:-10px">
                    ...
                    while($row=mysqli_fetch_array($query)){
                      ...
                      <tr>
                        <td><?php echo $cys;?></td>
                        <td>
                          <a id="click" class="mr-5" href="class.php?id=<?php echo $id;?>&cys=<?php echo $cys;?>">
                            <i class="glyphicon glyphicon-edit text-black"></i>
                            <span class="text-black">Edit</span>
                          </a>
                          <a id="removeme" href="../logic/class_del.php?id=<?php echo $id;?>">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                       ...
                       <input type="text" class="form-control border-1 mt-5" name="class" placeholder="Class Name" required>
                     </div><!-- /.form group -->
                   </div>
                 </div>	
                 <div class="form-group">
         ...
         <div class="box-body" style="" id="displayform">
          <!-- Date range -->
          <div id="form">
            <form method="post" action="../logic/class_update.php">
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control border-1 mt-5" id="class" name="class" value="<?php echo $_REQUEST['cys'];?>" placeholder="Class Name" required>
                  </div><!-- /.form group -->
                </div>
              </div>	
              <button class="btn btn-block btn-primary border-1" id="daterange-btn" name="save" type="submit">Update</button>
            </form>
          </div><!-- /.form group -->
        </div><!-- /.box-body -->
      </div><!-- /.box -->
