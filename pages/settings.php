                  ...
                  <div class="box-body">
                    ...
                    <form method="post" action="settings_save.php">
                      <div id="form">
                        <div class="row">
                          <div class="col-md-12">
                            <span class="section-title">Add Settings</span>
                            <div class="form-group">
                              <span for="date">Semester</span>
                            ...
                            <div class="form-group">
                              <span for="date">School Year</span>
                              <select class="form-control" style="width: 100%;" name="sy" required>
                               <?php
                               include('../dist/includes/dbcon.php');
